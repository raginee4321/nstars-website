...
import { Lock, Mail, User, Phone, Eye, EyeOff, Shield, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-lg px-6 py-12">
                ...
                {/* Signup Card */}
                <div className="relative bg-black bg-opacity-60 backdrop-blur-xl rounded-3xl p-8 md:p-10 border border-gray-700 shadow-2xl">
